            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Add Blogs Page</h4> <br> <br>
                        ...
                        <form method="POST" action="{{ route('store.blog') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="blog_description" rows="5" id="elm1"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg" src="{{ url('upload/no_image.jpg') }}" alt="blog Image">
                                </div>    
                            </div>


                            <button type="submit" class="btn btn-info btn-rounded waves-effect waves-light">Add Blog Data</button>
