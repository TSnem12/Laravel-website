                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('update.portfolio') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="portfolio_description" rows="5" id="portfolio_description">{{ $portfolio->portfolio_description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg" src="{{ url('upload/portfolio/'.$portfolio->portfolio_image) }}" alt="Portfolio Image">
                                </div>    
                            </div>

                            <button type="submit" class="btn btn-info btn-rounded waves-effect waves-light">Update Portfolio Data</button>
