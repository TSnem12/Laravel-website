                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('store.portfolio') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="portfolio_name" type="text" id="portfolio_name">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="portfolio_title" type="text" id="portfolio_title">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="portfolio_description" rows="5" id="portfolio_description"></textarea>
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-info btn-rounded waves-effect waves-light">Add Portfolio Data</button>
