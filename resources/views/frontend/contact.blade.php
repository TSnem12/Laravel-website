        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="contact__info">
                        <div class="contact__info__icon">
                            <img src="{{ 'frontend/assets/img/icons/contact_icon01.png' }}" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="contact__info">
                        <div class="contact__info__icon">
                            <img src="{{ 'frontend/assets/img/icons/contact_icon02.png' }}" alt="">
                        </div>
                        <div class="contact__info__content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="contact__info">
                        <div class="contact__info__icon">
                            <img src="{{ 'frontend/assets/img/icons/contact_icon03.png' }}" alt="">
                        </div>
                        <div class="contact__info__content">
