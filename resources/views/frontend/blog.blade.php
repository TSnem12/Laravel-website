                ...
                <div class="col-lg-8">
                    ...
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <a href="blog-details.html"><img src="{{ asset('upload/blog/' .$item->blog_image) }}" alt=""></a>
                                ...
                                @foreach($allBlogs as $all)
                                    <li class="rc__post__item">
                                        <div class="rc__post__thumb">
                                            <a href="blog-details.html"><img src="{{ asset('upload/blog/' .$all->blog_image) }}" alt=""></a>
                                        </div>
                            ...
                            <ul class="sidebar__cat">
                                @foreach($categories as $category)
                                    <li class="sidebar__cat__item">
                                        ...
                                        <a href="{{ route('category.blog', $category->id) }}">{{ $category->blog_category }}</a>
